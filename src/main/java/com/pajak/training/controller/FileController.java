...
import com.pajak.training.response.UploadFileResponse;
import com.pajak.training.service.FileStorageService;
...
public class FileController {
    ...
    public ResponseEntity<UploadFileResponse> uploadFile(@RequestParam("file") MultipartFile file) {
        ...
        try {
            ...
            return new ResponseEntity<>(new UploadFileResponse(),
